...
var _abadi199$elm_input_extra$Input_Decoder$eventDecoder = A5(
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'metaKey', _elm_lang$core$Json_Decode$bool));

var _abadi199$elm_input_extra$Input_KeyCode$allowedKeyCodes = _elm_lang$core$Native_List.fromArray(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('pure-menu')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Choose')
								])),
							A2(
...
var _user$project$Main$primaryKey = F3(
	function (model, tblName, ind) {
		if (_elm_lang$core$Native_Utils.eq(tblName, 'hospital')) {
			var h = A2(_user$project$Main$getNth, model.hospitals.list, ind);
			var _p0 = h;
			if (_p0.ctor === 'Just') {
				return function (_) {
			...
			if (_elm_lang$core$Native_Utils.eq(tblName, 'disease')) {
				var d = A2(_user$project$Main$getNth, model.diseases.list, ind);
				var _p1 = d;
				if (_p1.ctor === 'Just') {
					return function (_) {
						return _.virus_name;
				...
				if (_elm_lang$core$Native_Utils.eq(tblName, 'patient')) {
					var p = A2(_user$project$Main$getNth, model.patients.list, ind);
					var _p2 = p;
					if (_p2.ctor === 'Just') {
						return function (_) {
							return _.pid;
...
var _user$project$Main$Location = F2(
	function (a, b) {
		return {lat: a, lng: b};
	});
var _user$project$Main$SelList = F2(
	function (a, b) {
		return {list: a, sel: b};
	});
...
var _user$project$Main$medicDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'longitude',
	_elm_lang$core$Json_Decode$string,
	A3(
	...
	function (header, searchable, tbl, selIdx, objects) {
		...
		var rowAttrs = function (i) {
			var sel = _elm_lang$core$Native_Utils.eq(selectionIndex, i) ? _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('pure-table-odd')
				]) : _elm_lang$core$Native_List.fromArray(
				[]);
			var click = searchable ? _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
...
var _user$project$Main$viewMyInfo = function (model) {
	...
	switch (_p16.ctor) {
		...
		case 'MePagePatient':
			var tbl = _user$project$Main$patientTable;
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A5(_user$project$Main$viewTable, 'Your Doctor', false, _user$project$Main$medicTable, _elm_lang$core$Maybe$Nothing, model.medics)
							])),
						A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A5(_user$project$Main$viewTable, 'Your Symptoms', false, _user$project$Main$symptomTable, _elm_lang$core$Maybe$Nothing, model.symptoms)
							])),
						A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A5(_user$project$Main$viewTable, 'Your Disease Diagnosis', false, _user$project$Main$diseaseTable, _elm_lang$core$Maybe$Nothing, model.diseases.list)
							]))
					]));
		default:
			return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html$text(loginMsg)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$view = function (model) {
	var selectedQualfier = F2(
		function (selList, nameGetter) {
			var _p26 = selList.sel;
			if (_p26.ctor === 'Nothing') {
				return '(no selection above)';
			} else {
				var _p27 = A2(_user$project$Main$getNth, selList.list, _p26._0);
						...
						switch (_p28.ctor) {
							case 'HospitalPage':
								return A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A5(_user$project$Main$viewTable, 'Hospitals', true, _user$project$Main$hospitalTable, model.hospitals.sel, model.hospitals.list),
											A5(
											_user$project$Main$viewTable,
											A2(
												_elm_lang$core$Basics_ops['++'],
												'Diseases Treated',
												A2(
							...
							case 'PatientPage':
								return A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A5(_user$project$Main$viewTable, 'Patients', true, _user$project$Main$patientTable, model.patients.sel, model.patients.list),
											A5(
											_user$project$Main$viewTable,
											A2(
												_elm_lang$core$Basics_ops['++'],
							...
							case 'DiseasePage':
								return A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A5(_user$project$Main$viewTable, 'Diseases', true, _user$project$Main$diseaseTable, model.diseases.sel, model.diseases.list),
											A5(
											_user$project$Main$viewTable,
											A2(
												_elm_lang$core$Basics_ops['++'],
											...
											false,
											_user$project$Main$symptomTable,
											_elm_lang$core$Maybe$Nothing,
											model.symptoms)
										]));
							default:
...
var _user$project$Main$patientByContactedSourceCmd = function (pid) {
	...
	return A3(
		...
		A3(
			_user$project$Main$post$,
			_elm_lang$core$Json_Decode$list(_user$project$Main$patientDecoder),
			A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$baseUrl, '/patient-by-contacted-source'),
			body));
};
...
var _user$project$Main$patientByPIDCmd = function (pid) {
	...
	return A3(
		...
		A3(
			...
			A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$baseUrl, '/patient-me'),
			body));
};
			...
			_elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'columns',
						_1: _user$project$Main$encodeCols(_user$project$Main$symptomTable.columns)
					}
					]))));
	return A3(
		_elm_lang$core$Task$perform,
		...
		A3(
			_user$project$Main$post$,
			_elm_lang$core$Json_Decode$list(_user$project$Main$symptomDecoder),
			A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$baseUrl, '/patient-exhibits'),
			body));
};
var _user$project$Main$patientHasCmd = function (pid) {
	...
	return A3(
		...
		A3(
			_user$project$Main$post$,
			_elm_lang$core$Json_Decode$list(_user$project$Main$diseaseDecoder),
			A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$baseUrl, '/patient-has'),
			body));
};
...
var _user$project$Main$loadMyPageInfoCmd = function (model) {
	var _p29 = model.loginStatus;
	switch (_p29.ctor) {
		case 'Public':
			return _elm_lang$core$Platform_Cmd$none;
		case 'PatientLoggedIn':
			var _p31 = _p29._0;
			var _p30 = A2(_elm_lang$core$Debug$log, '***Going to batch: patient ByPid; exhibitsCmd, HasCmd, MedicCmd', 0);
			return _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$patientByPIDCmd(_p31),
						_user$project$Main$patientExhibitsCmd(_p31),
						_user$project$Main$patientHasCmd(_p31),
						_user$project$Main$patientMedicCmd(_p31)
					]));
		default:
			var _p32 = _p29._0;
			return _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$medicByMIDCmd(_p32),
						_user$project$Main$medicChecksOnCmd(_p32),
						_user$project$Main$medicsToDoCmd(_p32)
					]));
	}
};
			...
			switch (_p33.ctor) {
				case 'DB_HospitalTableSucceed':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								hospitals: {list: _p34, sel: _elm_lang$core$Maybe$Nothing},
								fields: _user$project$Main$tableFields(_user$project$Main$hospitalTable),
				...
				case 'DB_PatientTableSucceed':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								patients: {list: _p35, sel: _elm_lang$core$Maybe$Nothing},
				...
				case 'DB_MedicToDoSucceed':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								medicToDo: _p36,
								locationsForMap: mapLocations(_p36),
				...
				case 'DB_DiseaseTableSucceed':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								diseases: {list: _p33._0, sel: _elm_lang$core$Maybe$Nothing},
				...
				case 'DB_MedicByMidSucceed':
					var model$ = _elm_lang$core$Native_Utils.update(
						model,
						{
							mePage: _user$project$Main$MePageMedic(_p33._0)
						});
				...
				case 'DB_PatientByPidSucceed':
					var model$ = _elm_lang$core$Native_Utils.update(
						model,
						{
							mePage: _user$project$Main$MePagePatient(_p33._0)
						});
					return {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none};
				case 'DB_RequestFail':
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				case 'UI_MenuAct':
					...
					var newMode = _user$project$Menu$update(
						_user$project$Menu$Select(_p38));
					var _p37 = _p38;
					switch (_p37.ctor) {
						case 'HospitalPage':
							return {
				...
				case 'UI_UpdateLogin':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								loginNumberModel: A2(_abadi199$elm_input_extra$Input_Number$update, _p33._0, model.loginNumberModel)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'UI_UpdateFieldInput':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								fields: A3(_user$project$Main$updateField, _p33._0, _p33._1, model.fields)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'UI_RowSelected_Hospital':
					...
					return {
						...
						_1: _user$project$Main$diseaseByHospitalCmd(
							A3(_user$project$Main$primaryKey, model, _p33._0, _p42))
					};
				case 'UI_RowSelected_Disease':
					...
					var diseasesWithSelection = _elm_lang$core$Native_Utils.update(
						diseases,
						{
							sel: _elm_lang$core$Maybe$Just(_p43)
						});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_1: _user$project$Main$sympByDiseaseCmd(
							A3(_user$project$Main$primaryKey, model, _p33._0, _p43))
					};
				default:
					var _p44 = _p33._1;
					...
					var patientsWithSelection = _elm_lang$core$Native_Utils.update(
						patients,
						{
							sel: _elm_lang$core$Maybe$Just(_p44)
						});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_1: _user$project$Main$patientByContactedSourceCmd(
							A3(_user$project$Main$primaryKey, model, _p33._0, _p44))
					};
			}
		}();
		var _p45 = {
