...
var _user$project$Menu$update = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
...
var _user$project$Menu$view = F2(
	function (choices, sel) {
		var itemClass = F2(
			function (val, selVal) {
				return (!_elm_lang$core$Native_Utils.eq(val, selVal)) ? 'pure-menu-item' : 'pure-menu-item pure-menu-selected';
			});
		return A2(
										...
										return A2(
											_elm_lang$html$Html$li,
											{
												...
												_0: _elm_lang$html$Html_Attributes$class(
													A2(itemClass, _p4, sel)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Menu$Select(_p4)),
													_1: {ctor: '[]'}
												}
											},
											{
...
var _user$project$Model$medicTable = {
	name: 'medic',
	columns: {
		ctor: '::',
		_0: {
...
var _user$project$Model$symptomTable = {
	name: 'symptom',
	columns: {
		ctor: '::',
		_0: {
...
var _user$project$Model$diseaseTable = {
	name: 'disease',
	columns: {
		ctor: '::',
		_0: {
...
var _user$project$Model$patientTable = {
	name: 'patient',
	columns: {
		ctor: '::',
		_0: {
...
var _user$project$Model$hospitalTable = {
	name: 'hospital',
	columns: {
		ctor: '::',
		_0: {
...
var _user$project$Model$getNth = F2(
	function (items, i) {
		return A2(
...
var _user$project$Model$Location = F2(
	function (a, b) {
		return {lat: a, lng: b};
	});
var _user$project$Model$SelList = F2(
	function (a, b) {
		return {list: a, sel: b};
	});
											...
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return {hospitals: a, diseases: b, patients: c, otherPatients: d, medicChecksOn: e, medicToDo: f, locationsForMap: g, mapCaption: h, symptoms: i, medics: j, mode: k, loginStatus: l, mePage: m, loginNumberModel: n, loginNumberOptions: o, fields: p};
															};
														};
													};
												};
...
var _user$project$Model$Field = F2(
	function (a, b) {
		return {name: a, val: b};
	});
var _user$project$Model$tableFields = function (tbl) {
	return A2(
		_elm_lang$core$List$map,
		function (_p0) {
			var _p1 = _p0;
			return A2(_user$project$Model$Field, _p1._0, '');
		},
		tbl.columns);
};
var _user$project$Model$Table = F2(
	function (a, b) {
		return {name: a, columns: b};
	});
var _user$project$Model$Hospital = F4(
	function (a, b, c, d) {
		return {hospitalName: a, numberOfBeds: b, latitude: c, longitude: d};
	});
var _user$project$Model$Patient = F8(
	function (a, b, c, d, e, f, g, h) {
		return {pid: a, forename: b, surname: c, status: d, phoneNumber: e, dob: f, latitude: g, longitude: h};
	});
var _user$project$Model$Disease = F3(
	function (a, b, c) {
		return {virus_name: a, incubation: b, duration: c};
	});
var _user$project$Model$Symptom = F2(
	function (a, b) {
		return {symptom_name: a, description: b};
	});
var _user$project$Model$Medic = F6(
	function (a, b, c, d, e, f) {
		return {mid: a, name: b, phoneNumber: c, hospitalName: d, latitude: e, longitude: f};
	});
var _user$project$Model$UI_RowSelected_Patient = F2(
	function (a, b) {
		return {ctor: 'UI_RowSelected_Patient', _0: a, _1: b};
	});
var _user$project$Model$UI_RowSelected_Disease = F2(
	function (a, b) {
		return {ctor: 'UI_RowSelected_Disease', _0: a, _1: b};
	});
var _user$project$Model$UI_RowSelected_Hospital = F2(
	function (a, b) {
		return {ctor: 'UI_RowSelected_Hospital', _0: a, _1: b};
	});
var _user$project$Model$UI_RowSelected_Ignore = F2(
	function (a, b) {
		return {ctor: 'UI_RowSelected_Ignore', _0: a, _1: b};
	});
var _user$project$Model$UI_DoFieldSearch = {ctor: 'UI_DoFieldSearch'};
var _user$project$Model$UI_UpdateFieldInput = F2(
	function (a, b) {
		return {ctor: 'UI_UpdateFieldInput', _0: a, _1: b};
	});
var _user$project$Model$UI_MIDLoginAttempt = {ctor: 'UI_MIDLoginAttempt'};
var _user$project$Model$UI_PIDLoginAttempt = {ctor: 'UI_PIDLoginAttempt'};
var _user$project$Model$UI_UpdateLogin = function (a) {
	return {ctor: 'UI_UpdateLogin', _0: a};
};
var _user$project$Model$UI_MenuAct = function (a) {
	return {ctor: 'UI_MenuAct', _0: a};
};
var _user$project$Model$DB_PatientByPidSucceed = function (a) {
	return {ctor: 'DB_PatientByPidSucceed', _0: a};
};
var _user$project$Model$DB_MedicByMidSucceed = function (a) {
	return {ctor: 'DB_MedicByMidSucceed', _0: a};
};
var _user$project$Model$DB_MedicTableSucceed = function (a) {
	return {ctor: 'DB_MedicTableSucceed', _0: a};
};
var _user$project$Model$DB_SymptomSucceed = function (a) {
	return {ctor: 'DB_SymptomSucceed', _0: a};
};
var _user$project$Model$DB_DiseaseTableSucceed = function (a) {
	return {ctor: 'DB_DiseaseTableSucceed', _0: a};
};
var _user$project$Model$DB_MedicChecksOnSucceed = function (a) {
	return {ctor: 'DB_MedicChecksOnSucceed', _0: a};
};
var _user$project$Model$DB_MedicToDoSucceed = function (a) {
	return {ctor: 'DB_MedicToDoSucceed', _0: a};
};
var _user$project$Model$DB_OtherPatientTableSucceed = function (a) {
	return {ctor: 'DB_OtherPatientTableSucceed', _0: a};
};
var _user$project$Model$DB_PatientTableSucceed = function (a) {
	return {ctor: 'DB_PatientTableSucceed', _0: a};
};
var _user$project$Model$DB_MIDLoginResult = F2(
	function (a, b) {
		return {ctor: 'DB_MIDLoginResult', _0: a, _1: b};
	});
var _user$project$Model$DB_PIDLoginResult = F2(
	function (a, b) {
		return {ctor: 'DB_PIDLoginResult', _0: a, _1: b};
	});
var _user$project$Model$DB_RequestFail = function (a) {
	return {ctor: 'DB_RequestFail', _0: a};
};
var _user$project$Model$DB_HospitalTableSucceed = function (a) {
	return {ctor: 'DB_HospitalTableSucceed', _0: a};
};
var _user$project$Model$MyInfoPage = {ctor: 'MyInfoPage'};
var _user$project$Model$PatientPage = {ctor: 'PatientPage'};
var _user$project$Model$DiseasePage = {ctor: 'DiseasePage'};
var _user$project$Model$HospitalPage = {ctor: 'HospitalPage'};
var _user$project$Model$menu = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'Hospitals', _1: _user$project$Model$HospitalPage},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'Diseases', _1: _user$project$Model$DiseasePage},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Patients', _1: _user$project$Model$PatientPage},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'Me', _1: _user$project$Model$MyInfoPage},
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Model$MedicLoggedIn = function (a) {
	return {ctor: 'MedicLoggedIn', _0: a};
};
var _user$project$Model$PatientLoggedIn = function (a) {
	return {ctor: 'PatientLoggedIn', _0: a};
};
var _user$project$Model$Public = {ctor: 'Public'};
var _user$project$Model$NoMePage = {ctor: 'NoMePage'};
var _user$project$Model$initModel = {
	hospitals: {
		list: {ctor: '[]'},
		sel: _elm_lang$core$Maybe$Nothing
	},
	diseases: {
		list: {ctor: '[]'},
		sel: _elm_lang$core$Maybe$Nothing
	...
	medicChecksOn: {ctor: '[]'},
	medicToDo: {ctor: '[]'},
	locationsForMap: {ctor: '[]'},
	mapCaption: '',
	symptoms: {ctor: '[]'},
	medics: {ctor: '[]'},
	mode: _user$project$Model$HospitalPage,
	loginStatus: _user$project$Model$Public,
	mePage: _user$project$Model$NoMePage,
	loginNumberModel: _elm_lang$core$Maybe$Nothing,
	loginNumberOptions: _abadi199$elm_input_extra$Input_Number$defaultOptions(_user$project$Model$UI_UpdateLogin),
	fields: _user$project$Model$tableFields(_user$project$Model$hospitalTable)
};
var _user$project$Model$MePagePatient = function (a) {
	return {ctor: 'MePagePatient', _0: a};
};
var _user$project$Model$MePageMedic = function (a) {
	return {ctor: 'MePageMedic', _0: a};
};

var _user$project$Conversion$medicDecoder = A3(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'mid',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Medic)))))));
var _user$project$Conversion$symptomDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'description',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'symptom_name',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Symptom)));
var _user$project$Conversion$diseaseDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'duration',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			'virus_name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Disease))));
var _user$project$Conversion$patientDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'longitude',
	_elm_lang$core$Json_Decode$string,
	A3(
...
var _user$project$Conversion$hospitalDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'longitude',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'hospital_name',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Hospital)))));

var _user$project$View$localcss = A3(
	...
	'link',
	{
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href('localStyle.css'),
				_1: {ctor: '[]'}
			}
		}
	},
	{ctor: '[]'});
var _user$project$View$pureCSS = A3(
	_elm_lang$html$Html$node,
	'link',
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href('http://yui.yahooapis.com/pure/0.6.0/pure-min.css'),
				_1: {ctor: '[]'}
			}
		}
	},
	{ctor: '[]'});
var _user$project$View$viewTable = F5(
	function (header, searchable, tbl, selIdx, objects) {
		...
		var rowMsg = _elm_lang$core$Native_Utils.eq(tbl.name, 'hospital') ? _user$project$Model$UI_RowSelected_Hospital : (_elm_lang$core$Native_Utils.eq(tbl.name, 'patient') ? _user$project$Model$UI_RowSelected_Patient : (_elm_lang$core$Native_Utils.eq(tbl.name, 'disease') ? _user$project$Model$UI_RowSelected_Disease : _user$project$Model$UI_RowSelected_Ignore));
		var rowAttrs = function (i) {
			var sel = _elm_lang$core$Native_Utils.eq(selectionIndex, i) ? {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('pure-table-odd'),
				_1: {ctor: '[]'}
			} : {ctor: '[]'};
			var click = searchable ? {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					A2(rowMsg, tbl.name, i)),
				_1: {ctor: '[]'}
			} : {ctor: '[]'};
			return A2(_elm_lang$core$Basics_ops['++'], click, sel);
		};
		return A2(
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: searchable ? A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('pure-button pure-button-active search-button'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$UI_DoFieldSearch),
										_1: {ctor: '[]'}
									}
								},
								{
												...
												_1: {
													...
													_0: searchable ? A2(
														_elm_lang$html$Html$input,
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(
																_user$project$Model$UI_UpdateFieldInput(_p3)),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}) : A2(
														_elm_lang$html$Html$span,
...
var _user$project$View$viewMyInfo = function (model) {
	var _p6 = A2(
	...
	var _p8 = model.mePage;
	switch (_p8.ctor) {
		case 'MePageMedic':
			var tbl = _user$project$Model$medicTable;
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A5(_user$project$View$viewTable, 'Your Patients', false, _user$project$Model$patientTable, _elm_lang$core$Maybe$Nothing, model.medicChecksOn),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: A5(_user$project$View$viewTable, 'Today\'s todo list', false, _user$project$Model$patientTable, _elm_lang$core$Maybe$Nothing, model.medicToDo),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
		...
		case 'MePagePatient':
			var tbl = _user$project$Model$patientTable;
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A5(_user$project$View$viewTable, 'Your Doctor', false, _user$project$Model$medicTable, _elm_lang$core$Maybe$Nothing, model.medics),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: A5(_user$project$View$viewTable, 'Your Symptoms', false, _user$project$Model$symptomTable, _elm_lang$core$Maybe$Nothing, model.symptoms),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: A5(_user$project$View$viewTable, 'Your Disease Diagnosis', false, _user$project$Model$diseaseTable, _elm_lang$core$Maybe$Nothing, model.diseases.list),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Please login to view your information.'),
					_1: {ctor: '[]'}
				});
	}
};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Login ID'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(loginMsg),
							_1: {ctor: '[]'}
						}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$UI_PIDLoginAttempt),
						_1: {
							ctor: '::',
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('As Patient'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$UI_MIDLoginAttempt),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('pure-button'),
								_1: {ctor: '[]'}
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('As Medic'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$View$view = function (model) {
	var selectedQualfier = F2(
		function (selList, nameGetter) {
			var _p18 = selList.sel;
			if (_p18.ctor === 'Nothing') {
				return '(no selection above)';
			} else {
				var _p19 = A2(_user$project$Model$getNth, selList.list, _p18._0);
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$pureCSS,
			_1: {
				ctor: '::',
				_0: _user$project$View$localcss,
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						},
						{
							...
							_0: A2(
								...
								_user$project$Model$UI_MenuAct,
								A2(_user$project$Menu$view, _user$project$Model$menu, model.mode)),
							_1: {
								ctor: '::',
								_0: _user$project$View$loginView(model),
								_1: {
									ctor: '::',
									_0: function () {
										var _p20 = model.mode;
										switch (_p20.ctor) {
											case 'HospitalPage':
												return A2(
													...
													{
														ctor: '::',
														_0: A5(_user$project$View$viewTable, 'Hospitals', true, _user$project$Model$hospitalTable, model.hospitals.sel, model.hospitals.list),
														_1: {
															ctor: '::',
															_0: A5(
																_user$project$View$viewTable,
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	'Diseases Treated',
																	A2(
																...
																false,
																_user$project$Model$diseaseTable,
											...
											case 'PatientPage':
												return A2(
													...
													{
														ctor: '::',
														_0: A5(_user$project$View$viewTable, 'Patients', true, _user$project$Model$patientTable, model.patients.sel, model.patients.list),
														_1: {
															ctor: '::',
															_0: A5(
																_user$project$View$viewTable,
																...
																false,
																_user$project$Model$patientTable,
																_elm_lang$core$Maybe$Nothing,
																model.otherPatients),
															_1: {ctor: '[]'}
														}
											...
											case 'DiseasePage':
												return A2(
													...
													{
														ctor: '::',
														_0: A5(_user$project$View$viewTable, 'Diseases', true, _user$project$Model$diseaseTable, model.diseases.sel, model.diseases.list),
														_1: {
															ctor: '::',
															_0: A5(
																_user$project$View$viewTable,
																...
																false,
																_user$project$Model$symptomTable,
																_elm_lang$core$Maybe$Nothing,
																model.symptoms),
															_1: {ctor: '[]'}
														}
											...
											default:
												return _user$project$View$viewMyInfo(model);
										}
									}(),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(model.mapCaption),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$primaryKey = F3(
	function (model, tblName, ind) {
		if (_elm_lang$core$Native_Utils.eq(tblName, 'hospital')) {
			var h = A2(_user$project$Model$getNth, model.hospitals.list, ind);
			var _p0 = h;
			if (_p0.ctor === 'Just') {
				return function (_) {
					return _.hospitalName;
			...
			if (_elm_lang$core$Native_Utils.eq(tblName, 'disease')) {
				var d = A2(_user$project$Model$getNth, model.diseases.list, ind);
				var _p1 = d;
				if (_p1.ctor === 'Just') {
					return function (_) {
						return _.virus_name;
				...
				if (_elm_lang$core$Native_Utils.eq(tblName, 'patient')) {
					var p = A2(_user$project$Model$getNth, model.patients.list, ind);
					var _p2 = p;
					if (_p2.ctor === 'Just') {
						return function (_) {
							return _.pid;
		...
		A2(
			...
			function (f) {
				return _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(f.name),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string(f.val),
							_1: {ctor: '[]'}
						}
					});
			},
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'columns', _1: cols},
					_1: {ctor: '[]'}
				}
			}));
};
...
var _user$project$Main$postWithTwoHandlers = F5(
	function (url, body, decoder, succMsg, failMsg) {
		var handler = function (result) {
			var _p7 = result;
			if (_p7.ctor === 'Ok') {
				return succMsg(_p7._0);
			} else {
				return failMsg(_p7._0);
			}
		};
		return A2(
			...
			A3(
				...
				A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$baseUrl, url),
				body,
				decoder));
	});
var _user$project$Main$hospitalLoadCmd = A5(
...
var _user$project$Main$validatePidCmd = function (pid) {
	return A5(
		...
		_elm_lang$core$Json_Decode$bool,
		_user$project$Model$DB_PIDLoginResult(pid),
		_user$project$Model$DB_RequestFail);
};
var _user$project$Main$validateMidCmd = function (mid) {
	return A5(
		...
		_elm_lang$http$Http$emptyBody,
		_elm_lang$core$Json_Decode$bool,
		_user$project$Model$DB_MIDLoginResult(mid),
		_user$project$Model$DB_RequestFail);
};
var _user$project$Main$queryFieldsCmd = F4(
	function (tbl, fields, dec, successMsg) {
		...
		return A5(_user$project$Main$postWithTwoHandlers, '/query-fields', body, dec, successMsg, _user$project$Model$DB_RequestFail);
	});
var _user$project$Main$queryHospitalFieldsCmd = function (model) {
	return A4(
		_user$project$Main$queryFieldsCmd,
		_user$project$Model$hospitalTable,
		model.fields,
		_elm_lang$core$Json_Decode$list(_user$project$Conversion$hospitalDecoder),
		_user$project$Model$DB_HospitalTableSucceed);
};
...
var _user$project$Main$sympByDiseaseCmd = function (virusName) {
	...
	return A5(
		...
		'/symptom-by-disease',
		body,
		_elm_lang$core$Json_Decode$list(_user$project$Conversion$symptomDecoder),
		_user$project$Model$DB_SymptomSucceed,
		_user$project$Model$DB_RequestFail);
};
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'columns',
						_1: _user$project$Main$encodeCols(_user$project$Model$diseaseTable.columns)
					},
					_1: {ctor: '[]'}
				}
			}));
...
var _user$project$Main$patientByContactedSourceCmd = function (pid) {
	var body = _elm_lang$http$Http$jsonBody(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'pid',
					_1: _elm_lang$core$Json_Encode$string(pid)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'columns',
						_1: _user$project$Main$encodeCols(_user$project$Model$patientTable.columns)
					},
					_1: {ctor: '[]'}
				}
			}));
	return A5(
		_user$project$Main$postWithTwoHandlers,
		'/patient-by-contacted-source',
		body,
		_elm_lang$core$Json_Decode$list(_user$project$Conversion$patientDecoder),
		_user$project$Model$DB_OtherPatientTableSucceed,
		_user$project$Model$DB_RequestFail);
};
var _user$project$Main$medicByMIDCmd = function (mid) {
	var body = _elm_lang$http$Http$jsonBody(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'columns',
						_1: _user$project$Main$encodeCols(_user$project$Model$medicTable.columns)
					},
					_1: {ctor: '[]'}
				}
			}));
	return A5(_user$project$Main$postWithTwoHandlers, '/medic-me', body, _user$project$Conversion$medicDecoder, _user$project$Model$DB_MedicByMidSucceed, _user$project$Model$DB_RequestFail);
};
var _user$project$Main$medicChecksOnCmd = function (mid) {
	...
	return A5(
		...
		body,
		_elm_lang$core$Json_Decode$list(_user$project$Conversion$patientDecoder),
		_user$project$Model$DB_MedicChecksOnSucceed,
		_user$project$Model$DB_RequestFail);
};
var _user$project$Main$medicsToDoCmd = function (mid) {
	...
	return A5(
		...
		body,
		_elm_lang$core$Json_Decode$list(_user$project$Conversion$patientDecoder),
		_user$project$Model$DB_MedicToDoSucceed,
		_user$project$Model$DB_RequestFail);
};
var _user$project$Main$patientByPIDCmd = function (pid) {
	var body = _elm_lang$http$Http$jsonBody(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'pid',
					_1: _elm_lang$core$Json_Encode$int(pid)
				},
				_1: {
					ctor: '::',
					_0: {
	...
	return A5(_user$project$Main$postWithTwoHandlers, '/patient-me', body, _user$project$Conversion$patientDecoder, _user$project$Model$DB_PatientByPidSucceed, _user$project$Model$DB_RequestFail);
};
var _user$project$Main$patientExhibitsCmd = function (pid) {
	var body = _elm_lang$http$Http$jsonBody(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'columns',
						_1: _user$project$Main$encodeCols(_user$project$Model$symptomTable.columns)
					},
					_1: {ctor: '[]'}
				}
			}));
...
var _user$project$Main$patientHasCmd = function (pid) {
	var body = _elm_lang$http$Http$jsonBody(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
...
var _user$project$Main$patientMedicCmd = function (pid) {
	var body = _elm_lang$http$Http$jsonBody(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
	...
	return A5(
		...
		'/patient-medic',
		body,
		_elm_lang$core$Json_Decode$list(_user$project$Conversion$medicDecoder),
		_user$project$Model$DB_MedicTableSucceed,
		_user$project$Model$DB_RequestFail);
};
var _user$project$Main$loadMyPageInfoCmd = function (model) {
	var _p8 = model.loginStatus;
	switch (_p8.ctor) {
		case 'Public':
			return _elm_lang$core$Platform_Cmd$none;
		case 'PatientLoggedIn':
			var _p10 = _p8._0;
			var _p9 = A2(_elm_lang$core$Debug$log, '***Going to batch: patient ByPid; exhibitsCmd, HasCmd, MedicCmd', 0);
			return _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					_0: _user$project$Main$patientByPIDCmd(_p10),
					_1: {
						ctor: '::',
						_0: _user$project$Main$patientExhibitsCmd(_p10),
						_1: {
							ctor: '::',
							_0: _user$project$Main$patientHasCmd(_p10),
							_1: {
								ctor: '::',
								_0: _user$project$Main$patientMedicCmd(_p10),
								_1: {ctor: '[]'}
							}
						}
					}
		...
		default:
			...
			return _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					_0: _user$project$Main$medicByMIDCmd(_p11),
					_1: {
						ctor: '::',
						_0: _user$project$Main$medicChecksOnCmd(_p11),
						_1: {
							ctor: '::',
							_0: _user$project$Main$medicsToDoCmd(_p11),
							_1: {ctor: '[]'}
						}
					}
				});
...
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Model$initModel, _1: _user$project$Main$hospitalLoadCmd};
var _user$project$Main$showMarkers = _elm_lang$core$Native_Platform.outgoingPort(
	'showMarkers',
	function (v) {
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		var mapLocations = function (locatableList) {
			return A2(
				_elm_lang$core$List$map,
				function (x) {
					return A2(
						_user$project$Model$Location,
						$float(x.latitude),
						$float(x.longitude));
				},
				locatableList);
		};
		var errorNoOp = function (err) {
			var _p12 = _elm_lang$core$Debug$log(
			...
			switch (_p13.ctor) {
				case 'DB_HospitalTableSucceed':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								hospitals: {list: _p14, sel: _elm_lang$core$Maybe$Nothing},
								fields: _user$project$Model$tableFields(_user$project$Model$hospitalTable),
				...
				case 'DB_PatientTableSucceed':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								patients: {list: _p15, sel: _elm_lang$core$Maybe$Nothing},
								fields: _user$project$Model$tableFields(_user$project$Model$patientTable),
				...
				case 'DB_MedicToDoSucceed':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								medicToDo: _p16,
								locationsForMap: mapLocations(_p16),
				...
				case 'DB_DiseaseTableSucceed':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								diseases: {list: _p13._0, sel: _elm_lang$core$Maybe$Nothing},
								fields: _user$project$Model$tableFields(_user$project$Model$diseaseTable)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'DB_MedicTableSucceed':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								medics: _p13._0,
								fields: _user$project$Model$tableFields(_user$project$Model$medicTable)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'DB_MedicByMidSucceed':
					var model_ = _elm_lang$core$Native_Utils.update(
						model,
						{
							mePage: _user$project$Model$MePageMedic(_p13._0)
						});
				...
				case 'DB_PatientByPidSucceed':
					var model_ = _elm_lang$core$Native_Utils.update(
						model,
						{
							mePage: _user$project$Model$MePagePatient(_p13._0)
						});
					return {ctor: '_Tuple2', _0: model_, _1: _elm_lang$core$Platform_Cmd$none};
				case 'DB_RequestFail':
					return errorNoOp(_p13._0);
				case 'UI_MenuAct':
					var _p18 = _p13._0._0;
					var newMode = _user$project$Menu$update(
						_user$project$Menu$Select(_p18));
					var _p17 = _p18;
					switch (_p17.ctor) {
						case 'HospitalPage':
							return {
				...
				case 'UI_PIDLoginAttempt':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$validatePidCmd(
							_elm_lang$core$Basics$toString(
								A2(_elm_lang$core$Maybe$withDefault, 0, model.loginNumberModel)))
					};
				case 'UI_MIDLoginAttempt':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$validateMidCmd(
							_elm_lang$core$Basics$toString(
								A2(_elm_lang$core$Maybe$withDefault, 0, model.loginNumberModel)))
					};
				case 'DB_PIDLoginResult':
					var _p19 = _p13._1;
					if (_p19 === true) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									loginStatus: _user$project$Model$PatientLoggedIn(
										A2(
											_elm_lang$core$Result$withDefault,
											0,
					...
					if (_p20 === true) {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									loginStatus: _user$project$Model$MedicLoggedIn(
										A2(
											_elm_lang$core$Result$withDefault,
											0,
											_elm_lang$core$String$toInt(_p13._0)))
				...
				case 'UI_UpdateFieldInput':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								fields: A3(_user$project$Main$updateField, _p13._0, _p13._1, model.fields)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'UI_RowSelected_Hospital':
					...
					var hospWithSelection = _elm_lang$core$Native_Utils.update(
						hospitals,
						{
							sel: _elm_lang$core$Maybe$Just(_p22)
						});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_1: _user$project$Main$diseaseByHospitalCmd(
							A3(_user$project$Main$primaryKey, model, _p13._0, _p22))
					};
				case 'UI_RowSelected_Disease':
					...
					var diseasesWithSelection = _elm_lang$core$Native_Utils.update(
						diseases,
						{
							sel: _elm_lang$core$Maybe$Just(_p23)
						});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_1: _user$project$Main$sympByDiseaseCmd(
							A3(_user$project$Main$primaryKey, model, _p13._0, _p23))
					};
				default:
					var _p24 = _p13._1;
					...
					var patientsWithSelection = _elm_lang$core$Native_Utils.update(
						patients,
						{
							sel: _elm_lang$core$Maybe$Just(_p24)
						});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_1: _user$project$Main$patientByContactedSourceCmd(
							A3(_user$project$Main$primaryKey, model, _p13._0, _p24))
					};
			}
		}();
		var _p25 = {
			...
			_1: A2(
				...
				{
					ctor: '_Tuple2',
					_0: _elm_lang$core$Tuple$first(result).mode,
					_1: _elm_lang$core$Tuple$first(result).loginStatus
				})
		};
		return result;
	});
